...
urlpatterns = patterns('',
    ...
    url(r'^releaseDocPay/(?P<id>\d+)/$', views.release_Doc_Pay, name='release_doc_pay'),
    url(r'^releaseNurPay/(?P<id>\d+)/$', views.release_Nur_Pay, name='release_nur_pay'),
    url(r'^endTreatment/(?P<id>\d+)/$', views.bill_Appt, name='bill_appt'),
    url(r'confirmation', views.bill_Paid, name='bill_paid'),
    url(r'Sent', views.bill_Released, name='bill_released'),
    url(r'Released', views.pay_Released, name='pay_released'),
    url(r'^pdf/(?P<id>\d+)/$', views.pdf_gen, name = 'pdfgen'),
    url(r'^pdfNursePay/(?P<id>\d+)/$', views.view_Nur_Pay, name = 'pdfNur'),
    url(r'^pdfDocPay/(?P<id>\d+)/$', views.view_Doc_Pay, name = 'pdfDoc'),
    ...
    url(r'^editPatient/(?P<id>\d+)/$', views.edit_Patient, name = 'edit_patient'),
    url(r'^editNurse/(?P<id>\d+)/$', views.edit_Nurse, name = 'edit_nurse'),
    url(r'^editDoctor/(?P<id>\d+)/$', views.edit_Doctor, name = 'edit_doctor'),
